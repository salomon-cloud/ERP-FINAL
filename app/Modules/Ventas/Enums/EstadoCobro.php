...
/**
 * cobros.estado, segun chk_cobros_estado.
 *
 * Un cobro aplicado ya entro al banco: no se edita. Corregirlo es cancelarlo,
 * lo que devuelve su importe al saldo de la factura y pide la poliza de reversa.
 */
enum EstadoCobro: string implements EstadoPresentable
{
