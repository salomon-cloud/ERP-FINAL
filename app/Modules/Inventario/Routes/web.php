...
|         ->middleware('permission:inventario.pedidos.ver');   // inventario.pedidos.index, ...
|
...
|         ->middleware('permission:inventario.pedidos.confirmar');
|
...
// "inventario.dashboard": la barra lateral apunta ahi.
