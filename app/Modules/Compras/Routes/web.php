...
| prefijo de URL "/compras" y el prefijo de nombre "compras.".
...
|         ->middleware('permission:compras.pedidos.ver');   // compras.pedidos.index, ...
|
...
|         ->middleware('permission:compras.pedidos.confirmar');
|
...
// "compras.dashboard": la barra lateral apunta ahi.
