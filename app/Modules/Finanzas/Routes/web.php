...
/*
|--------------------------------------------------------------------------
| Finanzas y Contabilidad - rutas de navegador
|--------------------------------------------------------------------------
|
| Las registra automaticamente App\Providers\ModuleServiceProvider bajo el
| prefijo de URL "/finanzas" y el prefijo de nombre "finanzas.".
...
|         ->middleware('permission:finanzas.pedidos.ver');   // finanzas.pedidos.index, ...
|
...
|         ->middleware('permission:finanzas.pedidos.confirmar');
|
...
// "finanzas.dashboard": la barra lateral apunta ahi.
