...
/*
|--------------------------------------------------------------------------
| Compartido (Cimientos) - rutas del API JSON
|--------------------------------------------------------------------------
|
| Las registra automaticamente App\Providers\ModuleServiceProvider bajo el
| prefijo de URL "/api/compartido" y el prefijo de nombre "api.compartido.".
...
|         ->middleware('permission:compartido.pedidos.ver');
|
